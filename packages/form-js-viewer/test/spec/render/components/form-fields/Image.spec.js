...
function createImage({ services, ...restOptions } = {}) {
  const options = {
    field: defaultField,
    isExpression: () => false,
    ...restOptions,
