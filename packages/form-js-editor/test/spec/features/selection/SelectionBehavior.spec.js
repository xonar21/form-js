...
describe("features/selection", function () {
  ...
  beforeEach(
    bootstrapFormEditor(schema, {
      modules: [ModelingModule, SelectionModule],
    }),
  );

  it("should select new form field", inject(function (formEditor, modeling, selection) {
    // given
    const attrs = {
      id: "text3",
      type: "text",
  ...
  it("should select moved form field", inject(function (formEditor, formFieldRegistry, modeling, selection) {
    // given
  ...
  it("should select next form field on remove", inject(function (formEditor, formFieldRegistry, modeling, selection) {
    // given
  ...
  it("should select previous form field on remove", inject(function (
    formEditor,
    formFieldRegistry,
    modeling,
    selection,
  ...
  it("should deselect form field on undo", inject(function (commandStack, formEditor, modeling, selection) {
    // given
    const attrs = {
      id: "text3",
      type: "text",
