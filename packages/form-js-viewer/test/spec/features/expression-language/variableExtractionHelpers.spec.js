...
describe("getFlavouredFeelVariableNames", () => {
  ...
  expectVariables("VariableInIfExpression", 'if variable1 > variable2 then "yes" else "no"', [
    "variable1",
    "variable2",
  ]);
  ...
  expectVariables("NestedList", "[[variable1, variable2], [variable3, variable4]]", [
    "variable1",
    "variable2",
    "variable3",
    "variable4",
  ...
  expectVariables("VariableInUnaryTest", "variable1 in (variable2..variable3)", [
    "variable1",
    "variable2",
    "variable3",
  ]);
